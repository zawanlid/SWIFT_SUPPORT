...
public class CommonUtils {
	 ...
	 * @return
	 */
	public static final String convertDateToTimeString(Date date,
			String dateFormat) {
	...
	public static Date incrementDate(Date date, int seconds, int minutes,
			int hours) {
	 ...
	 * @return
	 */
	public static final String formatDoubleToFixedLength(String value,
			int length) {
	 ...
	 * @return
	 */
	public static final String formatDoubleWithPadding(String value,
			int length, char pad) {
	 ...
	 * @return
	 */
	public static final String formatIntWithPadding(int value, int length,
			char pad) {
	 ...
	 * @return
	 */
	public static final String formatLongWithPadding(long value, int length,
			char pad) {
	 ...
	 * @return
	 */
	public static final String formatStringWithPadding(String value,
			int length, char pad) {
	...
	public static Date parseDateWithMultiParser(String dateStr)
		...
		{
			// dateFormats.add(new
			// SimpleDateFormat(Constant.DATE_FORMAT_DDMMYYYY));
			dateFormats
					.add(new SimpleDateFormat(Constant.DATE_FORMAT_YYYYMMDD));
			dateFormats
					.add(new SimpleDateFormat(Constant.DATE_FORMAT_DDMMYYYY2));
			dateFormats
					.add(new SimpleDateFormat(Constant.DATE_FORMAT_TIMESTAMP));
		}
		;
